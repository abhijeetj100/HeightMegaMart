...
import heights.megamart.AppController;
...
public class Home_fragment extends Fragment {
    ...
    private void makeGetSliderRequest() {
       ...
       /* JsonArrayRequest req = new JsonArrayRequest(BaseURL.GET_SLIDER_URL,
        ...
        JsonArrayRequest req = new JsonArrayRequest(BaseURL.GET_SLIDERS,
                new Response.Listener<JSONArray>() {
                    @Override
                    public void onResponse(JSONArray response) {
                        ...
                        try {
                            ...
                            for (int i = 0; i < response.length(); i++) {
                              ...
                              //  url_maps.put("slider_image", BaseURL.GET_SLIDERS + jsonObject.getString("slider_image"));
...
*/
        ...
        CustomVolleyJsonRequest jsonObjReq = new CustomVolleyJsonRequest(Request.Method.POST,
                BaseURL.GET_CATEGORIES, params, new Response.Listener<JSONObject>() {
