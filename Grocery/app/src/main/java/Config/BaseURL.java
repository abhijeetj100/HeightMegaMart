...
public class BaseURL {
    ...
    public static final String KEY_SPONSERID = "sponser_id";
    ...
    public static final String BASE_URL2 = "https://infocentroid.us/";

    public static final String LOGIN_FORM = BASE_URL2 + "grocery_mlm/api/login?user_email=";

    public static final String GET_CATEGORIES = BASE_URL2 + "grocery_mlm/Api/get_categories";

    public static final String GET_PRODUCTS = BASE_URL2 + "grocery_mlm/Api/get_products";

    public static final String GET_SLIDERS = BASE_URL2 +"grocery_mlm/Api/get_sliders";

    public static final String GET_ABOUTUS = BASE_URL2 +"grocery_mlm/Api/aboutus";

    public static final String GET_SUPPORT = BASE_URL2 +"grocery_mlm/Api/support";

    public static final String GET_TERMS = BASE_URL2 +"grocery_mlm/Api/terms";

    public static final String GET_LIMITE_SETTING = BASE_URL2 + "grocery_mlm/Api/get_limit_settings";

    public static final String IMG_CATEGORY_URL = BASE_URL2 + "grocery_mlm/uploads/category/";

    public static final String IMG_SLIDER_URL = BASE_URL2 + "grocery_mlm/uploads/sliders/";

    public static final String IMG_PRODUCT_URL = BASE_URL2 + "grocery_mlm/uploads/products/";

     public static final String GET_PRIVACY = BASE_URL2 +"grocery_mlm/Api/privacy";

    public static final String GET_TIME_SLOT = BASE_URL2 + "grocery_mlm/Api/get_time_slot";

    public static final String GET_SOCITY = BASE_URL2 + "grocery_mlm/Api/get_society";

    public static final String ADD_ORDER = BASE_URL2 + "grocery_mlm/Api/send_order";

    public static final String GET_ORDER = BASE_URL2 + "grocery_mlm/Api/my_orders";

    public static final String ADD_ADDRESS = BASE_URL2 + "grocery_mlm/Api/add_address";

    public static final String GET_ADDRESS = BASE_URL2 + "grocery_mlm/Api/get_address";

    public static final String ORDER_DETAIL = BASE_URL2 + "grocery_mlm/Api/order_details";

    public static final String DELETE_ORDER = BASE_URL2 + "grocery_mlm/Api/cancel_order";

    public static final String CHANGE_PASSWORD = BASE_URL2 + "grocery_mlm/Api/change_password";

    public static final String DELETE_ADDRESS = BASE_URL2 + "grocery_mlm/Api/delete_address";

    public static final String EDIT_ADDRESS = BASE_URL2 + "grocery_mlm/Api/edit_address";

    public static final String RIGISTER_FCM = BASE_URL2 + "grocery_mlm/Api/register_fcm";

    public static final String EDIT_PROFILE = BASE_URL2 + "grocery_mlm/Api/update_userdata";

    public static final String FORGOT = BASE_URL2 + "grocery_mlm/Api/forgot_password";
